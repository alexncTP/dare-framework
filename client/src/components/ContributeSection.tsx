            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden">
              <div className="p-6">
                <div className="flex items-center">
                  ...
                  <h3 className="ml-3 text-xl font-medium text-gray-900">Traduzir</h3>
                </div>
                <div className="mt-4">
                  <p className="text-gray-600">
          ...
          <div className="mt-12 bg-white rounded-lg shadow-md overflow-hidden">
            <div className="p-8">
              ...
              <div className="mt-6 prose prose-blue max-w-none">
                ...
                <p>
                  Todos os colaboradores devem seguir nosso <a href="https://github.com/dare-framework/dare/blob/main/CODE_OF_CONDUCT.md" className="text-blue-600 hover:text-blue-700" target="_blank" rel="noopener noreferrer">Código de Conduta</a>, que promove um ambiente inclusivo e acolhedor.
                </p>
